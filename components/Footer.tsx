  ...
  return (
    <footer className="py-24 px-4">
      <div className="max-w-6xl mx-auto">
        <div
          className={cn(
            "relative flex flex-col items-center justify-center overflow-hidden rounded-[3rem] p-12 md:p-24 text-center transition-all duration-500",
        ...
        >
          ...
          <div className="w-full pt-12 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-[10px] font-bold tracking-[0.1em] text-neutral-500 uppercase">
            ...
            <div className="flex items-center gap-8">
              {["PLATFORM", "METHODOLOGY", "SECURITY", "CONTACT"].map((link) => (
                <a
                  key={link}
                  href="#"
                  className="text-[10px] font-bold tracking-[0.1em] text-neutral-500 hover:text-[#99ff66] transition-colors"
                >
                  {link}
                </a>
              ))}
